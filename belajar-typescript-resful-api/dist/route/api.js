...
// User API
exports.apiRouter.get("/api/users/current", user_controller_1.default.get);
exports.apiRouter.patch("/api/users/current", user_controller_1.default.update);
exports.apiRouter.delete("/api/users/current", user_controller_1.default.logout);
// Contact API
